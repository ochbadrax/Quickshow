    ...
    <footer className="px-6 pt-8 md:px-16 lg:px-36 w-full text-gray-300">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-10">
                <div className="md:max-w-96">
                    <img alt="" class="w-36" src={assets.logo} />
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    <div>
                        <h2 className="font-semibold mb-5">Бидний тухай</h2>
                    ...
                    <div>
                        <h2 className="font-semibold mb-5">Бидэнтэй холбогдох</h2>
                        <div className="text-sm space-y-2">
                            <p>95685155</p>
                            <p>daikaochbadrah@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © <a href="https://prebuiltui.com">ДАРХАН ХОТЫН СОЁЛ АМРАЛТЫН ХҮРЭЭЛЭН ОНӨААТҮГ</a>. All Right Reserved.
            </p>
        </footer>
  )
}
